/* Generated by Cython 0.9.8.1.1 on Sat Nov 29 01:17:58 2008 */
 ...
 */
    __pyx_2 = PyFloat_FromDouble(sqrt((pow((__pyx_v_freqs[__pyx_v_i]).re, 2) + pow((__pyx_v_freqs[__pyx_v_i]).im, 2)))); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     return _DFT(data)             # <<<<<<<<<<<<<<
 */
  __pyx_1 = __pyx_f_5pydft__DFT(__pyx_v_data); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_1;
  __pyx_1 = 0;
  goto __pyx_L0;
