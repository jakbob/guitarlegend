...
import timeit
repeats = 9001
#t1 = timeit.Timer("b = pydft.DFT(data)", "from __main__ import pydft, data").timeit(repeats)
t2 = timeit.Timer("b = pydft.FFT(data)", "from __main__ import pydft, data").timeit(repeats)
